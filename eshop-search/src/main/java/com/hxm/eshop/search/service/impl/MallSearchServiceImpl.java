package com.hxm.eshop.search.service.impl;
...
import com.hxm.eshop.search.constant.EsConstant;
import com.hxm.eshop.search.feign.ProductFeignService;
import com.hxm.eshop.search.service.MallSearchService;
import com.hxm.eshop.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse response = esRestClient.search(searchRequest, EshopEsSearchConfig.COMMON_OPTIONS);
